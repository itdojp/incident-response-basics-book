...
const cases = [
  ...
  ['mixed-quote xlink href resource', 'docs/assets/images/figures/ch05-severity-roles-timeline.svg', function (text) { return text.replace('</svg>', "<use xlink:href=\"other's.svg#shape\"/></svg>"); }],
