...
description: "トラブルシューティングからインシデント運用、連絡/復旧判断、ポストモーテムまでの基本フレームを扱う。"
author: "株式会社アイティードゥ"
version: "0.1.0"
permalink: /
layout: book
...
トラブルシューティングからインシデント運用、連絡/復旧判断、ポストモーテムまでの基本フレームを扱う。調査の型（仮説→検証→切り分け）を、初動・連絡・復旧・振り返りへ接続できる状態にする。
...
- 観測事実、仮説、判断、実施、結果を分けて記録し、引き継ぎ可能なタイムラインを作れる
- 通常障害とセキュリティ/プライバシー疑いで、証跡保全・エスカレーション・通知判断を分けられる
