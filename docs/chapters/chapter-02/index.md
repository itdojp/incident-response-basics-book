...
- [ ] 事象/影響を「インシデント記録」に書き出す（付録: [インシデント記録](../../appendices/templates/incident-log/)）
- [ ] 「これはインシデントか？」を暫定判断する（付録: [これはインシデントか？](../../appendices/templates/is-incident/)）
...
- 証跡（ログ/メトリクス/設定差分）を保全し、対象期間、取得元、加工有無、保管先を残す
